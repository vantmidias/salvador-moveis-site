...
export function Footer() {
    return (
        <footer className="bg-white pt-20 pb-10 border-t border-gray-100 overflow-hidden">
            <Container>
                <StaggerContainer delayChildren={0.1} staggerChildren={0.1} className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    <StaggerItem className="md:col-span-1 border-r border-gray-100">
                        <h3 className="font-outfit font-bold text-2xl text-brand-dark mb-4">Salvador Móveis</h3>
                        <p className="text-gray-500 font-light text-sm max-w-[200px]">
                            Elegância e sofisticação em móveis sob medida para o seu lar ou empresa.
                        </p>
                    </StaggerItem>

                    <StaggerItem>
                        <h4 className="font-bold text-brand-dark mb-4 tracking-wide text-sm uppercase">Contato</h4>
                        <div className="space-y-4">
                            <a href="https://wa.me/5554991404852" className="flex items-center gap-3 text-gray-500 hover:text-brand-primary transition-colors text-sm">
                                <Phone className="w-4 h-4" />
                                (54) 99140-4852
                            </a>
                            <a href="mailto:comercial@salvador-moveissobmedida.com.br" className="flex items-center gap-3 text-gray-500 hover:text-brand-primary transition-colors text-sm">
                    ...
                    <StaggerItem>
                        <h4 className="font-bold text-brand-dark mb-4 tracking-wide text-sm uppercase">Social</h4>
                        <div className="flex flex-col gap-2">
                            <a href="https://www.instagram.com/salvador.moveis/" target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 bg-gray-50 text-brand-dark px-4 py-2 rounded-lg hover:bg-brand-primary hover:text-white transition-all text-sm font-medium">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=100063502662418" target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 bg-gray-50 text-brand-dark px-4 py-2 rounded-lg hover:bg-brand-primary hover:text-white transition-all text-sm font-medium">
                            ...
                            <a href="https://wa.me/5554991404852" target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 bg-gray-50 text-brand-dark px-4 py-2 rounded-lg hover:bg-brand-primary hover:text-white transition-all text-sm font-medium">
                ...
                <FadeIn direction="up">
                    <div className="text-center border-t border-gray-100 pt-8 text-gray-400 text-xs">
