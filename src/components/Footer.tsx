                ...
                <StaggerContainer delayChildren={0.1} staggerChildren={0.1} className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <StaggerItem className="md:col-span-1 border-b pb-8 md:pb-0 md:border-b-0 md:border-r border-white/10">
                        ...
                        <div className="space-y-4">
                            <a href="https://wa.me/555496575742" className="flex items-center gap-3 text-gray-400 hover:text-brand-primary transition-colors text-sm">
                    ...
                    <StaggerItem className="md:col-span-1">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <a href="https://wa.me/555496575742" target="_blank" rel="noopener noreferrer" className="inline-flex w-fit items-center gap-2 bg-white/5 text-white px-4 py-2 rounded-lg hover:bg-brand-primary transition-all text-sm font-medium border border-white/10">
